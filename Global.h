...
typedef struct {
	...
	int rightJoyX, rightJoyY, leftJoyX, leftJoyY;
	bool btnUpdate, axisLXUpdate, axisLYUpdate, axisRXUpdate, axisRYUpdate;
} RPPadDataS;
...
EXPORT_C_(u32) PADreadPort1(RPPadDataS* RPpad);
EXPORT_C_(u32) PADreadPort2(RPPadDataS* RPpad);
